...
<script type="text/javascript">
	$(function(){
		...
		$(".count").change(function(){
			...
			//找到此图书的总金额叔叔标签
			var $amountEle = $(this).parents("tr").find("td:eq(3)");
			
			//发送请求
			//window.location.href = "${pageContext.request.contextPath}/client/CartServlet?method=changeCount&count="+count+"&bookId="+bookId;
			$.post("${pageContext.request.contextPath}/client/CartServlet?method=changeCount&count="+count+"&bookId="+bookId,function(data){
				//修改单品种图书的金额
				$amountEle.html(data.amount);
				//修改购物车总数量
