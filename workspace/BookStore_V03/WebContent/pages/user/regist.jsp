						...
						<div class="login_box">
							...
							<div class="form">
								<form action="client/UserServlet?method=regist" method="post">
									<label>用户名称：</label>
									<input class="itxt" type="text" <%=request.getParameter("username")==null?"":"value='"+request.getParameter("username")+"'" %> placeholder="请输入用户名" autocomplete="off" tabindex="1" name="username" />
									<br />
									<br />
									<label>用户密码：</label>
									<input class="itxt" type="password" <%=request.getParameter("password")==null?"":"value='"+request.getParameter("password")+"'" %> placeholder="请输入密码" autocomplete="off" tabindex="1" name="password" />
									<br />
									<br />
									<label>确认密码：</label>
									...
									<br />
									<label>电子邮件：</label>
									<input class="itxt" type="text" <%=request.getParameter("email")==null?"":"value='"+request.getParameter("email")+"'" %>  placeholder="请输入邮箱地址" autocomplete="off" tabindex="1" name="email" />
									<br />
									<br />
									<label>验证码：</label>
